    ...
    return (
        <div className="px-6 md:px-16 lg:px-10 py-10 font-roboto">
            ...
            <div className="overflow-x-auto md:overflow-visible">
                <div className="flex space-x-4 md:grid md:grid-cols-6 md:gap-4">
                    {products.map((product, index) => (
                        <div
                            key={index}
                            className="min-w-[200px] md:min-w-0 rounded-md bg-white px-4 py-2 shadow-sm hover:shadow-md transition flex flex-col justify-between h-full"
                        >
                            <div>
            ...
            <Link to="/allCatagories" className="flex items-center justify-center mt-10">
                <button className="text-center bg-white py-2 hover:text-white hover:bg-darkRed transition-colors duration-300 px-20 rounded-full text-sm font-bold text-gray">
                    See All
                </button>
            </Link>
        </div>
